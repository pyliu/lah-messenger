...
div
  ...
  .center.d-flex.my-2
    b-input-group(prepend="電腦")
      b-input.mr-1(v-model="uIp", :state="$utils.isIPv4(uIp)", placeholder="... 輸入電腦IP ...", readonly, trim, title="輸入電腦IP")
  
  .center.d-flex.my-2
    b-input-group(prepend="分機")
      b-input.mr-1(v-model="ext", placeholder="... 輸入分機號碼 ...", readonly, trim, title="輸入分機號碼")

  .center.d-flex.my-2
    b-input-group(prepend="工作")
      b-input.mr-1(v-model="work", placeholder="... 輸入工作描述 ...", readonly, trim, title="輸入工作描述")
